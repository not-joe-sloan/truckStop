//
//  settings-truckDescriptionViewController.swift
//  truckApp
//
...
class settings_truckDescriptionViewController: UIViewController {
    ...
    @IBAction func savePressed(_ sender: Any) {
        ...
        query.getFirstObjectInBackground(block: { (truck, error) in
            ...
            if truck != nil{
                ...
                truck?.setValue(description, forKey: "truckDescription")
